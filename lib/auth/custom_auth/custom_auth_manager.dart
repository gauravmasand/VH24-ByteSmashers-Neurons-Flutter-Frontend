...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    neuronsAuthUserSubject.add(
      NeuronsAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<NeuronsAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  NeuronsAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = NeuronsAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    neuronsAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
